...
class OnnxModel:
    def __init__(self):
        ...
        self.sess = onnxruntime.InferenceSession("E:\LargeModel\kaldi\sherpa_onnx_model\stream_zipformer\punct_ct_transformer_zh_en\model.onnx", session_opts)
...
def main():
    ##大写英文字符不行，要先转为小写
    text = "你好HELLO can YOU SPEAK ENGLISH".lower()
    model = OnnxModel()
    result = model(text)
    print(result)
