...
user_avatar = os.path.join(os.path.dirname(__file__), "assets/user.png")
chatot_avatar = os.path.join(os.path.dirname(__file__), "assets/chatbot.png")
with gr.Blocks() as demo:
    with gr.Row():
        with gr.Column(scale=1, min_width=200):
            ...
            # with open('cache/model_loader_val.txt','r', encoding='utf-8') as file:
            #     s_model_loader = file.read()
            # model = model.strip('\n').split('\n')[-1]
            model.change(save_model, inputs=[model], outputs=None)
            # with open('cache/model_val.txt','r', encoding='utf-8') as file:
            #     s_model = file.read()
            ...
            # with open('cache/cut_params.json','r') as file:
            #     cut_params = json.loads(file.read())
            # with open('cache/params.json','r') as file:
